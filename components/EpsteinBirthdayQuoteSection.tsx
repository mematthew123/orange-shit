                ...
                <div className='mx-auto max-w-4xl animate-fade-up'>
                    <figure>
                        <blockquote className='relative text-3xl font-medium tracking-tight text-foreground sm:text-4xl lg:text-5xl'>
                            <p className='before:content-["Happy birthday"] after:content-["Jeffery"] sm:before:absolute sm:before:right-full sm:before:-mr-4 sm:before:text-6xl sm:before:text-muted-foreground/30 sm:after:absolute sm:after:left-full sm:after:ml-4 sm:after:text-6xl sm:after:text-muted-foreground/30'>
