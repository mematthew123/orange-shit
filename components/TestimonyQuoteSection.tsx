    ...
    return (
        <section className='isolate overflow-hidden bg-background px-6 lg:px-8'>
            <div className='relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl'>
                <div className='absolute top-0 left-1/2 -z-10 h-[200px] w-[360px] -translate-x-1/2 bg-[radial-gradient(50%_100%_at_top,theme(colors.destructive/10),theme(colors.background))] opacity-20 lg:left-36' />
                <div className='absolute inset-y-0 right-1/2 -z-10 mr-12 w-[150vw] origin-bottom-left skew-x-[-30deg] bg-card shadow-xl ring-1 shadow-destructive/10 ring-border sm:mr-20 md:mr-0 lg:right-full lg:-mr-36 lg:origin-center' />
                ...
                <figure className='grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10'>
                    ...
                    <div className='col-end-1 w-16 lg:row-span-4 lg:w-72'>
                        <div className='aspect-square rounded-xl bg-gradient-to-br from-destructive/20 to-destructive/10 lg:rounded-3xl flex items-center justify-center'>
                            <svg
                                className='w-32 h-32 text-destructive/40'
                                fill='none'
                                viewBox='0 0 24 24'
                                stroke='currentColor'
                            >
